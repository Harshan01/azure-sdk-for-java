...
public final class PassFailMetric {
    /*
     * The client metric on which the criteria should be applied. Allowed
     * values - ‘response_time_ms’ , ‘latency’, ‘error’, ‘requests’,
     * ‘requests_per_sec’.
     */
     ...
     * ‘p99’, ‘min’, ‘max’ - for response_time_ms and latency metric, ‘avg’ -
     * for requests_per_sec, ‘count’ - for requests.
     */
     ...
     * [0.0 , 100.0] unit- % ’, response_time_ms and latency : any integer
     * value unit- ms.
     */
    ...
    /*
     * Either ‘stop’ or ‘continue’ after the threshold is met. Default is
     * ‘continue’.
     */
    ...
    /*
     * Outcome of the test run. possible outcome - ‘passed’ , ‘failed’ ,
     * ‘undetermined’.
     */
