...
/** Initializes a new instance of the AzureLoadTesting type. */
public final class AzureLoadTestingImpl {
    ...
    /**
     * Initializes an instance of AzureLoadTesting client.
     *
     * @param endpoint URL to perform data plane API operations on the resource.
     * @param apiVersion Api Version.
     */
    AzureLoadTestingImpl(String endpoint, String apiVersion) {
        this(
     ...
     * @param apiVersion Api Version.
     */
    AzureLoadTestingImpl(HttpPipeline httpPipeline, String endpoint, String apiVersion) {
